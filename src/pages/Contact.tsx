...
const Contact = () => {
  ...
  const contactInfo = [
    { icon: Mail, label: 'Email', value: 'info@sebastianstores.com', href: 'mailto:info@sebastianstores.com' },
    { icon: Phone, label: 'Phone', value: '8943555200', href: 'tel:+918943555200' },
    { icon: MapPin, label: 'Address', value: 'Regd Office 2211,2/1149/I 100 T2, Hilite Business Park, Calicut 673014, KL, India' },
    ...
    <main className="min-h-screen">
      <section className="bg-primary text-primary-foreground py-16 md:py-24">
        <div className="container text-center max-w-2xl mx-auto">
          <p className="text-xs tracking-[0.3em] uppercase mb-3 text-accent">Get in Touch</p>
          <h1 className="font-display text-3xl md:text-4xl font-bold mb-4">Contact Us</h1>
          <p className="text-sm opacity-90">Have questions? We'd love to hear from you. Send us a message and we'll respond as soon as possible.</p>
        </div>
      </section>
      ...
      <section className="container py-16 md:py-24">
        <div className="grid md:grid-cols-5 gap-12 max-w-5xl mx-auto">
          ...
          <div className="md:col-span-2 space-y-8">
            <div>
              <h2 className="font-display text-lg font-bold mb-6">Contact Information</h2>
              <div className="space-y-5">
                {contactInfo.map((c) => (
                  <div key={c.label} className="flex items-start gap-3">
                    <c.icon className="w-4 h-4 mt-0.5 text-accent" />
                    <div>
                      <p className="text-xs text-muted-foreground tracking-widest uppercase">{c.label}</p>
                      {c.href ? (
          ...
          <form onSubmit={handleSubmit} className="md:col-span-3 space-y-5">
            <h2 className="font-display text-lg font-bold mb-2">Send a Message</h2>
